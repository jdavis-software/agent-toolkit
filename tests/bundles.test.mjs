...
test('eighteen bundles cover all 112 original skills and 318 new scenario inputs',async()=>assert.deepEqual(await validateExpansion(root),{bundles:18,skills:112,scenarioInputs:318}));
