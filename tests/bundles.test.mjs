...
test('sixteen bundles cover all 104 original skills and 294 new scenario inputs',async()=>assert.deepEqual(await validateExpansion(root),{bundles:16,skills:104,scenarioInputs:294}));
